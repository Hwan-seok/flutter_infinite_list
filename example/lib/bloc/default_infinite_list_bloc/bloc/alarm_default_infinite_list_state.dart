...
class AlarmInfiniteListState
    extends InfiniteListState<Alarm, AlarmInfiniteListState> {
  ...
  @override
  AlarmInfiniteListState copyWith(
      {InfiniteList<Alarm>? infList, bool? anotherField}) {
